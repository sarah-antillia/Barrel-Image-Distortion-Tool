...
class ImageMaskAugmentor:
  ...
  def __init__(self, config_file):
     ...
     self.amount     = self.config.get("augmentor",   "amount") 
     self.radius     = self.config.get("augmentor",  "radius")
  ...
  def distort(self, image_file, mask_file):
    ...
    for center in self.centers:
      ...
      output_image_filepath = os.path.join(self.output_images_dir, 
                      "barrdistorted_"+str(index) + "_" + str(self.radius) 
                      + "_" + str(self.amount) + "_" + image_basename)    
      ...
      output_mask_filepath = os.path.join(self.output_masks_dir, 
                      "barrdistorted_"+str(index) + "_" + str(self.radius) 
                      + "_" + str(self.amount) + "_" + mask_basename)    
