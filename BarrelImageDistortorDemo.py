...
from BarrelImageDistortor import BarrelImageDistorter
...
class BarrelImageDistorterDemo(BarrelImageDistorter):
  ...
  def __init__(self, config_file):
     ...
     self.radius     = self.config.get("barrdistortion", "radius", dvalue=0.3)
     self.amount     = self.config.get("barrdistortion", "amount", dvalue=0.3)
     self.centers    = self.config.get("barrdistortion", "centers", dvalue=[(0.3, 0.3), (0.5, 0.5), (0.7, 0.7)])
     self.images_dir = self.config.get("barrdistortion", "images_dir", dvalue="./meshed_images") 
     self.output_dir = self.config.get("barrdistortion", "output_dir", dvalue="./distorted_meshed_images") 
